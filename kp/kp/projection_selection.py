...
class CandidateRejectionReason(str, Enum):
    ...
    UNSUPPORTED_GAMMA_LAYOUT = "UNSUPPORTED_GAMMA_LAYOUT"
    UNSUPPORTED_SPIN_ROUTE = "UNSUPPORTED_SPIN_ROUTE"
    INVALID_GAMMA_ROW_LAYOUT = "INVALID_GAMMA_ROW_LAYOUT"
    GAMMA_Q_ROUTE_MISMATCH = "GAMMA_Q_ROUTE_MISMATCH"
    LOCAL_ACTION_ISOMETRY = "LOCAL_ACTION_ISOMETRY"
    RAW_ACTION_ROUTE_LEAKAGE = "RAW_ACTION_ROUTE_LEAKAGE"
    AMBIGUOUS_ENERGY_CLUSTER = "AMBIGUOUS_ENERGY_CLUSTER"
    AMBIGUOUS_CLUSTER_CAPTURE = "AMBIGUOUS_CLUSTER_CAPTURE"
    SYMMETRY_CLOSURE_FAILURE = "SYMMETRY_CLOSURE_FAILURE"
    AMBIGUOUS_SOURCE_GROUP_ROUTING = "AMBIGUOUS_SOURCE_GROUP_ROUTING"
    EMPTY_SOURCE_GROUP = "EMPTY_SOURCE_GROUP"
    SOURCE_GROUP_RANK_CHANGE = "SOURCE_GROUP_RANK_CHANGE"
    SOURCE_GROUP_ROUTE_COVARIANCE = "SOURCE_GROUP_ROUTE_COVARIANCE"
    PROJECTOR_FRAME_RANK = "PROJECTOR_FRAME_RANK"
    HANDOFF_K_COVERAGE = "HANDOFF_K_COVERAGE"
    HANDOFF_IDENTITY = "HANDOFF_IDENTITY"
    CANDIDATE_SYMMETRY_FAILED = "CANDIDATE_SYMMETRY_FAILED"
