...
REQUIRED_SOURCE_MANIFEST_LINES = {
    ...
    "prune examples/mgi2_3.89/tapw/outputs",
    "prune examples/mote2_3.89/kp/outputs",
    "prune examples/mote2_3.89/kp/runs",
    "prune examples/mote2_3.89/tapw/outputs",
    "prune examples/mote2_aab_5.09/tapw/outputs",
    "prune examples/ptse2_7.34/tapw/outputs",
    "prune examples/zrs2_3.15/tapw/outputs",
    "global-exclude *.npy",
    "global-exclude *.npz",
